...
ConfigWidget::ConfigWidget()
{
    ...
    ADD_VALUE(field_vars,Double,Field_Penalty_Width,1.6,"Penalty width")
    ADD_VALUE(field_vars,Double,Field_Penalty_Depth,0.8,"Penalty depth")
    ADD_VALUE(field_vars,Double,Field_Penalty_Point,0.8,"Penalty point")
    ...
    ADD_VALUE(field_vars,Double,Goal_Width,0.800,"Goal width")
