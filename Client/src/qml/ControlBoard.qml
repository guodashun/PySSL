            ...
            ZGroupBox{
                ...
                Grid{
                    ...
                    Grid{
                        ...
                        property int itemWidth : (width - (columns-1) * columnSpacing - 2*padding)/columns;
//                        ZComboBox{
//                            id:interfaces4BlueSender;
//                            onActivated: interaction.changeRadioInterface(true,true,currentIndex);
//                            function updateModel(){
//                                model = interaction.getInterfaces();
//                                if(currentIndex >= 0)
//                                    interaction.changeRadioInterface(true,true,currentIndex);
//                            }
//                            Component.onCompleted: {
//                                model = interaction.getInterfaces();
//                            }
//                        }
//                        ZComboBox{
//                            id:interfaces4YellowSender;
//                            onActivated: interaction.changeRadioInterface(false,true,currentIndex);
//                            function updateModel(){
//                                model = interaction.getInterfaces();
//                                if(currentIndex >= 0)
//                                    interaction.changeRadioInterface(false,true,currentIndex);
//                            }
//                            Component.onCompleted: {
//                                model = interaction.getInterfaces();
//                            }
//                        }
//                        ZComboBox{
//                            id:interfaces4BlueReceiver;
//                            onActivated: interaction.changeRadioInterface(true,false,currentIndex);
//                            function updateModel(){
//                                model = interaction.getInterfaces();
//                                if(currentIndex >= 0)
//                                    interaction.changeRadioInterface(true,false,currentIndex);
//                            }
//                            Component.onCompleted: {
//                                model = interaction.getInterfaces();
//                            }
//                        }
//                        ZComboBox{
//                            id:interfaces4YellowReceiver;
//                            onActivated: interaction.changeRadioInterface(false,false,currentIndex);
//                            function updateModel(){
//                                model = interaction.getInterfaces();
//                                if(currentIndex >= 0)
//                                    interaction.changeRadioInterface(false,false,currentIndex);
//                            }
//                            Component.onCompleted: {
//                                model = interaction.getInterfaces();
//                            }
